...
def normalize_name(name: str) -> str:
    ...
    # OCR correction FIRST (before stripping non-alpha)
...
def extract_from_text(ocr_text: str, mrz_data: Optional[Dict] = None) -> Dict[str, Any]:
    """
    ...
    if not result["birth_date"]:
        ...
        # Normalize comma-separated dates (OCR artifact)
